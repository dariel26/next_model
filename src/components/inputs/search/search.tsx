...
export default function SearchInput(props: SearchInputProps) {
    ...
    //VARIABLES
    const initialSearch = searchParams.get(SEARCH_PARAMS_KEY)?.toString() ?? "";
    ...
    const updateSearchParams = useCallback(
        (search: string | ChangeEvent<HTMLInputElement>) => {
            ...
            if (search === "") urlSearchParams.delete(SEARCH_PARAMS_KEY);
            else urlSearchParams.set(SEARCH_PARAMS_KEY, search);
